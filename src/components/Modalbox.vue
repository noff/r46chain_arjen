<template>
  <div>
    ...
    <div>
      <button class="conditionButton"><canvas width="170" height="70" id="conditioncanvas" @click="selectType(1)"></canvas></button>
      <button class="actionButton"><canvas width="170" height="70" id="actioncanvas" @click="selectType(2)"></canvas></button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    selectType (value) {
      ...
      temp[this.value] = value
      temp[this.value * 2] = 0
      temp[this.value * 2 + 1] = 0
